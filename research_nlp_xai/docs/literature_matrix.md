...
This document summarizes key research papers related to emotion recognition, explainable AI, transformer models, fairness, and responsible NLP. It serves as a reference for experiment design, model selection, and research gap identification.

| Paper                                            | Dataset             | Models              | Main Findings                                          | Limitations                     | Relevance to My Research       |
| ------------------------------------------------ | ------------------- | ------------------- | ------------------------------------------------------ | ------------------------------- | ------------------------------ |
| GoEmotions (Demszky et al., 2020)                | GoEmotions          | BERT, BiLSTM        | BERT outperforms BiLSTM; grouping emotions improves F1 (Ekman style grouping and sentiment grouping) | Reddit-only data; English only  | Primary dataset and baseline   |
