...
| SHAP (Lundberg & Lee, 2017)                      | General             | Model-Agnostic      | Provides feature attribution explanations              | Computationally expensive,  O(2^n) large datasets with size n    | Explainability analysis        |
