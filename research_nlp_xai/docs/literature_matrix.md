...
| SHAP (Lundberg & Lee, 2017)                      | General             | Model-Agnostic      | Provides feature attribution explanations              | Computationally expensive, \( \(2^{n}\) for large datasets    | Explainability analysis        |
